...
$coreModuleOrder = @(
    ...
    'modules\content\genreParser.js',                   # Parse genre tags from URLs (P:, C:, R:, etc.)
    'modules\content\contentDeduplication.js',          # Track shown content to prevent repetition
    'modules\content\mediaFeedbackManager.js',          # User likes/dislikes feedback system
