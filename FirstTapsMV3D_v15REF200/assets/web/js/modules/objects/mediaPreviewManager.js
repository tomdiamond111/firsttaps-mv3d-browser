...
window.MediaPreviewManagerClass = class MediaPreviewManager {
    ...
    createPreview(objectData, objectMesh) {
        ...
        try {
            ...
            // CRITICAL FIX: Hide all other previews BEFORE storing the new one
            // This prevents hideAllPreviews() from accidentally hiding the new preview
            this.hideAllPreviews();
            
            // Store preview and show it
