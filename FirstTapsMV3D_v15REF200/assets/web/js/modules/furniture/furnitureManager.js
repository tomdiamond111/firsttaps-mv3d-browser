    ...
    class FurnitureManager {
        ...
        async loadFurnitureForCurrentWorld() {
            ...
            if (needsSave) {
                ...
                await this.storageManager.saveAllFurniture();
            }
        ...
        async createFurniture(config) {
            ...
            // CRITICAL FIX: Ensure camera controls are properly enabled after furniture creation
            // Sometimes creating furniture can leave controls in a bad state
            if (this.app && this.app.cameraControls) {
                ...
                console.log('🪑 Camera controls ensured enabled after furniture creation');
            }
        ...
        async removeObjectFromFurniture(furnitureId, objectId) {
            ...
            if (slotIndex >= 0) {
                ...
                if (objectMesh && objectMesh.userData) {
                    ...
                    // CRITICAL FIX: Clear manually placed flag when object is removed from furniture
                    // User removed this object, so it's no longer "manually placed" on furniture
                    if (objectMesh.userData.manuallyPlaced) {
                        objectMesh.userData.manuallyPlaced = false;
                        console.log(`🪑🔧 ✅ Cleared manuallyPlaced flag - object ${objectId} is no longer on furniture`);
                    }
