...
(function() {
    ...
    class MoveManager {
        ...
        startMovingObject(object) {
            ...
            // CRITICAL FIX: Mark furniture as having been explicitly moved by user
            // This prevents showing controls on newly created furniture
            if (object.userData.isFurniture) {
                object.userData._initialPositionSet = true;
                console.log('🪑 Marked furniture as explicitly moved by user');
            }
        ...
        async handleObjectMoveEnd() {
            ...
            setTimeout(() => {
                ...
                // 🎯 Furniture controls showing logic removed
                // Controls should ONLY show when entering closeup/rotation mode (double-tap)
                // NOT after moving furniture - this prevents premature control display on new furniture
                if (object.userData.isFurniture) {
                    console.log('🎮 Furniture moved - controls will show when user enters rotation mode (double-tap)');
                }
