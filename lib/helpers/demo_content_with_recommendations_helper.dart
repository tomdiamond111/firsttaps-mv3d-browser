...
import 'package:firsttaps_mv3d_browser/models/file_model.dart' as fm;
import 'package:firsttaps_mv3d_browser/services/state_manager_service.dart';
import 'package:firsttaps_mv3d_browser/managers/recommendation_content_manager.dart';
import 'package:firsttaps_mv3d_browser/models/link_object.dart';
import 'package:firsttaps_mv3d_browser/config/recommendations_config.dart';
...
class DemoContentWithRecommendationsHelper {
  ...
  static Future<String> generateJavaScriptPlaylists({
    ...
    shortsAndReels: {
      ...
      if (contentMap.containsKey('bookshelf') &&
          contentMap['bookshelf']!.isNotEmpty) {
        final links = contentMap['bookshelf']!
            .map((f) => "'${f.path}'")
            .take(6)
            .join(', ');
        jsPlaylists.add('''
