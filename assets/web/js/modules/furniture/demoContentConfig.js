...
(function() {
    ...
    const DEMO_PLAYLISTS = {
        // ═════════════════════════════════════════════════════════════
        // GALLERY WALL - Video mix (API + hardcoded)
        // Target: YouTube (4 from API), TikTok (3 max), Instagram (2 max), Vimeo (2 max), Dailymotion (2 from API)
        // TOTAL MIX: 4 YT + 3 TikTok + 2 Instagram + 2 Vimeo + 2 Dailymotion = 13 videos
        // ═════════════════════════════════════════════════════════════
        topHitsMix: {
            furnitureType: 'gallery_wall',
            title: 'Top Hits Mix',
            links: [
                // 🔄 UPDATE THESE LINKS REGULARLY (YouTube + Dailymotion come from API)
                // LIMIT: 3 TikTok max (matching Dart recommendation_service.dart limit)
                'https://www.tiktok.com/@ifkf137/video/7594422601221426462',        // TikTok 1
                'https://www.tiktok.com/@nttavernllc/video/7605800744792411422',    // TikTok 2
                'https://www.tiktok.com/@overtime/video/7609535801252154637',       // TikTok 3
                // LIMIT: 2 Vimeo max
                'https://vimeo.com/336892869',                                       // Vimeo 1 (Rick Astley - working video)
                // LIMIT: 2 Instagram max
                'https://www.instagram.com/reel/CdIxYYqgXYZ/',                       // Instagram 1
            ]
        },
